...
class PurchaseFlowTest < ActionDispatch::IntegrationTest
  def setup
    ...
    @product1 = create(:product, name: 'Laptop', price: 1000, stock_quantity: 5, category: @category, status: :active)
    @product2 = create(:product, name: 'Mouse', price: 50, stock_quantity: 10, category: @category, status: :active)
  end
