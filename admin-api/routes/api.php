            ...
            try {
                $stats = [
                    ...
                    'revenue' => [
                        ...
                        'this_month' => \App\Models\Order::whereMonth('created_at', now()->month)->sum('total_amount'),
                        'last_month' => \App\Models\Order::whereMonth('created_at', now()->subMonth()->month)->sum('total_amount'),
                    ]
                ];
